...
blocklist_set="     <HaGeZi>        https://raw.githubusercontent.com/hagezi/dns-blocklists/main/ips/tif.txt  {4}
                    <Mal_IN>        https://raw.githubusercontent.com/romainmarcoux/malicious-ip/main/full-40k.txt  {4}
                    <Mal_OUT>       https://raw.githubusercontent.com/romainmarcoux/malicious-outgoing-ip/main/full-outgoing-ip-aa.txt  {4}
                    <Scanners>      https://raw.githubusercontent.com/ShadowWhisperer/IPs/master/Other/Scanners  {4}
                    <Talos>         https://raw.githubusercontent.com/romainmarcoux/malicious-ip/main/sources/snort.org-aa.txt  {4}
